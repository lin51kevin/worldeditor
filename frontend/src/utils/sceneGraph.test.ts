...
function makeRoad(): Road {
  return {
    ...
    lane_sections: [{
      ...
      single_side: false,
      left: [
        { id: 1, lane_type: 'Driving', level: false, link: { predecessor: null, successor: null }, width: [{ s_offset: 0, a: 3.5, b: 0, c: 0, d: 0 }], road_marks: [] },
        { id: 2, lane_type: 'Driving', level: false, link: { predecessor: null, successor: null }, width: [{ s_offset: 0, a: 3.2, b: 0, c: 0, d: 0 }], road_marks: [] },
      ],
