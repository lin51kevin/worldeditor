...
const EcosystemPanel = () => createElement(
  'div',
  { style: { padding: 12, color: '#8b949e' } },
  'Ecosystem tools are coming soon (Phase 3).',
);
export function mountEcosystemPlugin(): () => void {
  ...
  registerPanel({ id: `${PLUGIN_ID}:panel`, pluginId: PLUGIN_ID, title: 'Ecosystem', titleKey: 'panels.ecosystem', component: EcosystemPanel, position: 'left', category: 'tools' });
