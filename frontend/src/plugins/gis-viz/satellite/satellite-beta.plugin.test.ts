...
const rp = vi.fn(), ro = vi.fn(), u = vi.fn();
vi.mock('../../../stores/pluginContribStore', () => ({ usePluginContribStore: { getState: vi.fn(() => ({ registerPanel: rp, registerViewportOverlay: ro, unregisterPlugin: u })) } }));
