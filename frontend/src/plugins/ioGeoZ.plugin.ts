/**
 * GeoZ import plugin.
 * Imports the proprietary GeoZ format (ZIP containing .topo + .geo protobuf files)
 * and converts to OpenDRIVE Project for editing.
 *
 * Reference: worldeditoronline/src/typescript/core/JSSDK/RoadNetworkJSSDK.ts
 */
