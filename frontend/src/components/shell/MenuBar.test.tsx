...
function createPlatformMock() {
  ...
  const platform: PlatformService = {
    ...
    generateObjectVerticesCached: vi.fn<PlatformService['generateObjectVerticesCached']>().mockResolvedValue(new Float32Array()),
    generateSingleRoadSurfaceVerticesCached: vi.fn<PlatformService['generateSingleRoadSurfaceVerticesCached']>().mockResolvedValue(new Float32Array()),
    ...
    updateCachedRoad: vi.fn<PlatformService['updateCachedRoad']>().mockResolvedValue(undefined),
    ...
    loadGaussianSplatsNative: vi.fn<PlatformService['loadGaussianSplatsNative']>().mockResolvedValue({
      meta: { count: 0, shDegree: 0, shStride: 12, layoutVersion: 2, layoutName: 'transform-f32-opacity-sh-f16', origin: [0, 0, 0], min: [0, 0, 0], max: [0, 0, 0] },
