...
export interface PlatformService {
  ...
  /** Set the minimum world-space width (metres) applied to thin line/stripe geometry (lane marks,
   *  crosswalk/hatch stripes, area outlines, stop/yield lines) generated by subsequent vertex calls,
   *  so they stay screen-visible at low zoom despite MSAA being disabled. Pass 0 to disable clamping. */
  setMinLineWidthM(widthM: number): Promise<void>;
